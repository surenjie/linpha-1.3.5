...
#################################################*/
/* left menu */
$album="My Photo Archive";

/* alerts */
$alert_fopen="Error! file could not be opened...";
$printing_probs="Printing problems";
$printing_probs_msg="Printing disabled! see";
...
$thumb_hint_msg="click for detailed view";
$latest_photo="latest";
$view_at="view at";
$close_button="close";
$help="help";
...
#################################################*/
/* install.php (page 1) */
$welc_header="Welcome to LinPHA";
$welc_text="Hi, this is the home of the &quot;The Linux Photo Archive&quot; aka LinPHA.
			It seems that you are running LinPHA for the first time, therefore you NEED to
			run install!.";
$welc_hint="<b>Before you continue:</b>";
$welc_hint1="Make directory &quot;<b>linpha/sql</b>&quot; world writeable!
			(i.e. chmod 777 sql)";
$next_button="Continue"; /* used as left menu header in all 4 stages */
$inst_msg="LinPHA Installation"; /* used as left menu header in all 4 stages */
$inst_status_1="Please select a language and click &quot;Continue&quot;";
$inst_status_step1="Step 1 of 4";

/* sec_stage_install (page 2) */
$inst_access_msg="Configure Database Access Type";
$inst_full_access_msg="<b>YES !</b><br> I have full access to the MySQL database, I'm allowed to create new<br>
						databases and new users. In other words: This is my Server!";
$inst_limited_access_msg="<b>NO !</b><br> I'm going to install LinPHA with limited access to the<br>
						MySQL database. My ISP does not allow the creation of new databases or users.";
$inst_status_2="Please choose SQL access type, if unsure choose NO!";
$inst_status_step2="Step 2 of 4";

/* requirements */
$req_check_msg="Checking System Requirements";
$req_found_msg="OK found";
$req_miss_msg="NOT found";
$req_safe_fail="ENABLED";
$req_safe_ok="DISABLED";
$php_safemode_check_msg="checking for PHP safe mode...";
$php_version_check_msg="checking for PHP version > 4.1.0...";
$mem_check_msg="checking PHP memory limit...";
$gd_check_msg="checking for GD library...";
$convert_check_msg="checking for ImageMagick...";
$exif_check_msg="checking for EXIF support...";
$summary_msg="SUMMARY:";
...
$inst_abort_msg="!!! INSTALLATION ABORTED !!!";
...
$session_path_found_msg="Session save path is set in php.ini to: ";
$session_path_miss_msg="NO value found for session_save_path.";
...
$table_create="Creating table:";
$table_create_error="Error while creating tables!";
$table_create_ok="OK, created!";
$table_insert_admin="Creating Admin using name:";
$table_insert_admin_error="Error while creating Admin account!";
$table_insert_admin_ok="OK, created!";
$write_db_config="Storing Database config to file";
$fopen_error="Could not open sql/db_config.php for writing, do a chmod 777 and restart installation";
$fopen_ok="OK, config written!";
$install_finish_msg="OK. Installation complete!!";
$admin_task="click to continue";
$file_create_ok="OK, created!";
$configure_error="Please fill in all required fields !!!";
...
## index.php
#################################################*/
$index_welc_text="Hi, this is the home of &quot;The PHP Photo Archive&quot; aka " .
		"<a href='http://linpha.sf.net/'><u>LinPHA.</u></a>.";

/*#################################################
## search.php
#################################################*/
$search_header="Linpha-Search";
$radio_all="All";
$radio_descript="Description";
$radio_comment="Comment";
$radio_category="Category";
$radio_file="Filename";
$search_in="Search in Album";
$search_all="All Albums";
$search_for="Search Keyword";
$search_button="Search";
$photos_found="found";
$search_info="LinPHA search page";
$search_msg="Search photos in the LinPHA database by:";

/*#################################################
## img_view.php
#################################################*/
$img_detail="Image details";
$img_size="fullsize";
$img_com="comment";
$img_des="description";
$img_cat="category";
$img_name="name";
$img_info_stored="Comments written to DB";
$please_login="Please <a href='login.php'><font color='#000099'><u>login</u></font></a> to add a comment";
$back_to_thumbs="<b><u>back to thumbnail view</u></b>";
$back_to_search="<b><u>back to search</u></b>";
$button_next="next";
$button_prev="previous";
$exif_ext_error="NO EXIF support in PHP version, sorry";
$exif_error="Sorry, image does not contain any exif information!";
$exif_more="more details";
$exif_less="less details";
$detail_header="Photo";
$detail_header1="of";
$detail_header2="in folder";
...
$img_rotate_ok="rotate picture";
$img_rotating="Image rotation problems"; // TOC entry
...
$login_name="Username";
$login_pass="Password";
$login_info="LinPHA login page";
$login_request_account_info="To request a new account:";
$login_request_target="Contact the LinPHA Administrator";
$login_admin_info="To perform administrative tasks login with your LinPHA admin account";
$login_friend_account_info="If you already have a &quot;friend&quot; account,
you can modify your personal setting here";
...
$back_to_msg="<b>back to photos</b>";
$href_general_conf="General Configuration";
$href_user_conf="User Management";
...
$mysql_table_check="Checking table";
...
$lostpw_error_nothing_found="Sorry, no username or email has been found that match your criterias."; /* (login.php) --  */
...
$comment_end="no more images in album"; /* (linpha_comments.php) --  */
...
$comment_last_comments="latest comments"; /* (linpha_comments.php) --  */
...
$mail_replace_words="<b>[Name]</b>, <b>[Email]</b> and <b>[My_LinPHA]</b> will be replaced with the name, email address of the specific users and the location of your LinPHA installation"; /* (form_mailing.php) --  */
...
$general_exif_rotate_info="<-- image auto rotation by EXIF data"; /* () --  */
...
$maps_select_type="Please select Map Type:"; /* (maps plugin) --  */
...
$map_auto_popup_info="<-- auto show Marker Popups on mouseover"; /* (maps plugin) --  */
